import 'package:gamez_hub/src/core/movies/domain/entities/game_entity.dart';
...
class GamesModel extends GamesEntity {
  ...
  final PlatformModel? esrbRating;
  ...
  factory GamesModel.fromJson(Map<String, dynamic> json) {
    return GamesModel(
      ...
      esrbRating: json['esrb_rating'] != null
          ? new PlatformModel.fromJson(json['esrb_rating'])
          : null,
    );
  }
...
class PlatformsModel extends PlatformsEntity {
  ...
  final RequirementsEnModel? requirementsEn;
  ...
  factory PlatformsModel.fromJson(Map<String, dynamic> json) {
    return PlatformsModel(
      ...
      requirementsEn: json['requirements_en'] != null
          ? new RequirementsEnModel.fromJson(json['requirements_en'])
          : null,
...
class RequirementsEnModel extends RequirementsEnEntity {
  ...
  factory RequirementsEnModel.fromJson(Map<String, dynamic> json) {
    return RequirementsEnModel(
