...
class GamesEntity extends Equatable {
  ...
  final PlatformEntity? esrbRating;
...
class PlatformsEntity extends Equatable {
  ...
  final RequirementsEnEntity? requirementsEn;
...
class RequirementsEnEntity extends Equatable {
  final String minimum;
  final String recommended;

  RequirementsEnEntity({required this.minimum, required this.recommended});
